...
const ConteudoSobreMim = () => {
  return (
    <SecaoSobreMim>
      ...
      <p>
        {" "}
        Meu nome é Rodrigo Santana de Araujo, e após 9 anos dedicado à Economia,
        decidi trilhar um novo caminho profissional. A paixão pela área de
        desenvolvimento Front End me impulsionou a buscar conhecimento e
        aprimorar minhas habilidades em HTML, CSS, JavaScript e React.
      </p>
      <p>
        {" "}
      ...
      <p>
        {" "}
        A busca pela progressão na área de Front End é uma decisão consciente. A
        possibilidade de criar interfaces inovadoras e interativas me fascina, e
        a constante evolução tecnológica me mantém em constante aprendizado. Sou
        um entusiasta da cultura Geek, viciado em animes e praticante de Jiu
        Jitsu há mais de 6 anos, faixa marrom. Acredito que a disciplina e a
        perseverança cultivadas nesses hobbies me impulsionam a alcançar meus
      ...
      <p>
        ...
        ambiente desafiador e dinâmico, onde possa aplicar meus conhecimentos e
